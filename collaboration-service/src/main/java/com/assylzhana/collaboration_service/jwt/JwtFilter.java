package com.assylzhana.collaboration_service.jwt;


import com.assylzhana.collaboration_service.dto.UserDto;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    private UserDto getUserDetails(String token) {
        try {
            String url = "http://user-service/user/email/" + jwtUtil.extractUsername(token);
